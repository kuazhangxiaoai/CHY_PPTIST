 ...
 * sr: 空间参考
 */
export interface PPTMap2dElement extends PPTBaseElement {
  type: 'map2d'
  fixedRatio: boolean
  color: string
  sr: string
...
export type PPTElement = PPTTextElement | PPTImageElement | PPTShapeElement | PPTLineElement | PPTChartElement | PPTTableElement | PPTLatexElement | PPTVideoElement | PPTAudioElement | PPTMap2dElement
